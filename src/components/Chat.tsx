...
const Chat = ({ deleteConversation }: { deleteConversation: () => void }) => {
            ...
            <div className="w-full h-15 p-1 bg-purple-600 dark:bg-gray-800 shadow-md rounded-xl rounded-bl-none rounded-br-none">
                <div className="flex p-2 align-middle items-center">
                    ...
                    <>
                        ...
                        <div className="p-2 text-white cursor-pointer hover:bg-purple-500 rounded-full" onClick={deleteConversation}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
